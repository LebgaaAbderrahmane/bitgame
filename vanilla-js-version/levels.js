const LEVELS = [
    ...
    },
    {
        ...
        instruction: "Combine loops and turns to weave through the grid.",
        hint: "Try to find a repeating pattern to simplify your code."
    },
    {
        id: 6,
    ...
    },
    {
        ...
        hint: "If you hit a wall, you'll need to go around (down and then back up)."
    },
    {
        id: 9,
        ...
        availableCards: ["MOVE", "IF_GEM", "IF_WALL", "REPEAT"],
    ...
    },
    {
        ...
        availableCards: ["MOVE", "REPEAT", "IF_GEM", "IF_WALL", "CREATE_BLOCK", "CALL"],
        instruction: "Use everything you've learned. Sequences, Loops, Conditionals, and Blocks.",
        hint: "Create a 'SMART MOVE' block that handles gems and walls."
    }
];
